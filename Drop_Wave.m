...
z=[(x*(cos(12*sqrt(x^2 + y^2)) + 1))/(x^2/2 + y^2/2 + 2)^2 + (12*x*sin(12*sqrt(x^2 + y^2)))/(sqrt(x^2 + y^2)*(x^2/2 + y^2/2 + 2)),...
   (y*(cos(12*sqrt(x^2 + y^2)) + 1))/(x^2/2 + y^2/2 + 2)^2 + (12*y*sin(12*sqrt(x^2 + y^2)))/(sqrt(x^2 + y^2)*(x^2/2 + y^2/2 + 2))];
end
...
if nargout > 1 % gradient required
    g=[(x(1)*(cos(12*sqrt(x(1)^2 + x(2)^2)) + 1))/(x(1)^2/2 + x(2)^2/2 + 2)^2 + (12*x(1)*sin(12*sqrt(x(1)^2 + x(2)^2)))/(sqrt(x(1)^2 + x(2)^2)*(x(1)^2/2 + x(2)^2/2 + 2)),...
   (x(2)*(cos(12*sqrt(x(1)^2 + x(2)^2)) + 1))/(x(1)^2/2 + x(2)^2/2 + 2)^2 + (12*x(2)*sin(12*sqrt(x(1)^2 + x(2)^2)))/(sqrt(x(1)^2 + x(2)^2)*(x(1)^2/2 + x(2)^2/2 + 2))];
end
